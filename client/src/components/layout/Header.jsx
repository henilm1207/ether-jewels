          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/" className="flex-shrink-0" style={{ margin: 0, padding: '5px 0' }}>
                <img src={logoSrc} alt="MITVA JEWELS" className="hidden md:block" style={{ width: '140px', height: 'auto' }} />
                <img src={logoSrc} alt="MITVA JEWELS" className="md:hidden" style={{ width: '100px', height: 'auto' }} />
              </Link>
            </div>
